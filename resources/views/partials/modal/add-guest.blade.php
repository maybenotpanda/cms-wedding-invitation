    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> <i class="fas fa-rocket"></i>Add Guest Invitation</h5>
            ...
            <form action="{{ route('invitation.store') }}" method="POST">
                    ...
                    <div id="form-container">
                        <div class="single-form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Tamu Undangan"
                                    name="name[]">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" name="request" class="btn btn-dark btn-block btn-sm">
                        Invitation<i class="fa fa-save"></i></button>
                </div>
            </form>
        </div>
    </div>
